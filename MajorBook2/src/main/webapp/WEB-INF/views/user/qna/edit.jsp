			...
			<form action=""  method="post" >
				...
				<div class="col-md-2"> 
					<div class="form-group"> 
						...
						<select class="form-control" name="qnaStatus">
				...
				<!-- <div class="col-md-6">
					<div class="form-group"> 
						...
						<input type="hidden" name="qnaNo" id="qnaNo" value="${bean.qnaNo }"><!-- 글번호 -->
						<input type="hidden" name="qnaNick" value="${bean.qnaNick }" id="qnaNick"><!-- 닉네임이라고하지만 관리자 -->
						<input type="hidden" name="qnaDay" value="${bean.qnaDay}" disabled="disabled"><!-- 작성일 -->
					
				<div class="col-md-12 text-center">
						<button class="btn btn-primary" type="submit">수정완료</button>
						<a class="btn btn-default" href="../../qna/">목록</a>
