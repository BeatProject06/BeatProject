...
public class BbsVo {
	...
	public String toString() {
		return "BbsVo [no=" + no + ", id=" + id + ", nickName=" + nickName + ", university=" + university + ", dept="
				...
				+ ", costPrice=" + costPrice + ", salePrice=" + salePrice + ", status=" + status + ", day=" + day
				+ ", title=" + title + ", content=" + content + ", imgFile=" + imgFile + "]";
	}

	public BbsVo(int no, String id, String nickName, String university, String dept, String bookName, String publisher,
			String author, String iSBN, int costPrice, int salePrice, String status, Date day, String title,
